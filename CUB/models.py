...
def ModelXtoCtoY(n_class_attr, pretrained, freeze, num_classes, use_aux, n_attributes, expand_dim,
    ...
    return End2EndModel(model1, model2, n_attributes, use_relu, use_sigmoid, n_class_attr)
...
class End2EndModel(torch.nn.Module):
    def __init__(self, model1, model2, n_attributes = 112, use_relu=False, use_sigmoid=False, n_class_attr=2):
    ...
    def forward_stage2(self, stage1_out):
        ...
        all_out.extend(stage1_out) # stage1_out is where the concept is outputed
        return all_out
